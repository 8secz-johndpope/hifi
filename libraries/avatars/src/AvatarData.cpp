...
QByteArray AvatarData::toByteArray(bool cullSmallChanges, bool sendAll) {
    ...
    header->globalBoundingBoxCorner[0] = _globalBoundingBoxCorner.x;
    header->globalBoundingBoxCorner[1] = _globalBoundingBoxCorner.y;
    header->globalBoundingBoxCorner[2] = _globalBoundingBoxCorner.z;
