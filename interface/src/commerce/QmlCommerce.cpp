...
void QmlCommerce::buy(const QString& assetId, int cost, const QString& buyerUsername, const bool controlledFailure) {
    auto ledger = DependencyManager::get<Ledger>();
    auto wallet = DependencyManager::get<Wallet>();
    ...
    ledger->buy(key, cost, assetId, key, buyerUsername, controlledFailure);
}
