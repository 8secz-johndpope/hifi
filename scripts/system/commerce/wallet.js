...
var SIDELOAD_ITEM = "Sideload Apps";
var SIDELOAD_QML_SOURCE = "hifi/commerce/sideload/Sideload.qml";
function startup() {
    ...
    if (!Menu.menuItemExists(DEVELOPER_MENU, SIDELOAD_ITEM)) {
        Menu.addMenuItem({ menuName: DEVELOPER_MENU, menuItemName: SIDELOAD_ITEM, isCheckable: false })
    }

    Menu.menuItemEvent.connect(function (menuItem) {
        if (menuItem === SIDELOAD_ITEM) {
            tablet.loadQMLSource(SIDELOAD_QML_SOURCE);
        }
    });
}
var isWired = false;
...
function shutdown() {
    ...
    Menu.removeMenuItem(DEVELOPER_MENU, SIDELOAD_ITEM);
}
